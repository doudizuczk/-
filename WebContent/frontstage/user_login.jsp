				...
				<form id="loginForm">
					<div class="sign-in-htm">
						<div class="group">
							...
							<input id="user" type="text" class="input" name="owerAccount">
						</div>
						<div class="group">
							<label for="pass" class="label">密码</label>
							<input id="pass" type="password" class="input" data-type="password" name="owerPwd">
						</div>
						<div class="group">
					...
					<form id="registerForm">
						<div class="group">
							<label for="owerAccount" class="label">用户名</label>
							<input id="owerAccount" type="text" class="input" name="owerAccount" onblur="checkAccount()"><span id="errorMess"></span>
						</div>
						<div class="group">
							<label for="owerPwd" class="label">密码</label>
							<input id="owerPwds" type="password" class="input" data-type="password" name="owerPwd">
						</div>
						<div class="group">
							<label for="confirm" class="label">确认密码</label>
							<input id="confirm" type="password" class="input" data-type="password" name="checkPwd">
						</div>
						<div class="group">
							<label for="owerPhone" class="label">手机号</label>
							<input id="owerPhone" type="text" class="input" name="owerPhone">
						</div>
						<div class="group">
							<label for="checkCode" class="label">验证码</label>
							<input id="checkCode" type="text" class="input" name="checkCode" placeholder="请输入您收到的短信验证码...">
						</div>
						<div class="group">
