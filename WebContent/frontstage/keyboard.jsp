...
<html lang="zh-CN">
	...
	<head>
		...
		<!-- layer -->
		<script type="text/javascript" src="<%=request.getContextPath()%>/userstyle/plugins/layer_mobile/layer.js"></script>
		<!--软键盘-->
		<script type="text/javascript" src="<%=request.getContextPath()%>/userstyle/plugins/webKeyBoard.js"></script>
		<!-- fonticon -->
	...
	<body class="fadeIn animated bg-color7">
		<header class="ui-header clearfix w75 h8 f46 pl3 pr3 color8 bg-color-primary t-c o-h">
			<div class="ui-header-l fl w5">
				<a href="index.jsp" class="icon color8 iconfont icon-home_light"></a>
			</div>
